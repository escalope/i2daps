...
public class DERAgentProtocol implements AgentProtocols{
...
public DERAgentProtocol(){};		
	...
	public ActiveConversation initialiseProtocols(String agentName,RuntimeConversation conv, 
        ...
        // Adds a protocol to the protocol queue
		   ...
		   if (conv.getInteraction().getId().equals("Interaction0") && conv.getPlayedRole().equals("DER")){
		   	DefaultCommControl dcc=new DERInteraction0DefaultCommControl(
                        		   conv.getConversationID(),msr,lr);
			sb = new DERInteraction0StateBehavior(agentName,
				msr, msu,
				conv,                           		
				conv.getPlayedRole(),
			   	actors,
