...
*/
			...
			public class DERAgentInteractionLocks implements CustomLocks {
			
			public DERAgentInteractionLocks(){};
			
			        public void addInteractionLocks(String interaction, LocksWriter lw, String role){
                                    
                   if (interaction.equals("Interaction0") && role.equals("DER") ){
                            DERInteraction0DefaultCommControl.addDefaultLocks(lw);
                   }
