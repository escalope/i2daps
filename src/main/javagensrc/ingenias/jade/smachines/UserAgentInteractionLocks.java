...
*/
			...
			public class UserAgentInteractionLocks implements CustomLocks {
			
			public UserAgentInteractionLocks(){};
                  ...
                  if (interaction.equals("Interaction0")&& role.equals("User")){
                    UserInteraction0DefaultCommControl.addDefaultLocks(lw);
                  }
